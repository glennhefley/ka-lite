...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ZoneInstallCertificate.install_certificate'
        db.delete_column('securesync_zoneinstallcertificate', 'install_certificate')

        # Adding field 'ZoneInstallCertificate.signed_value'
        db.add_column('securesync_zoneinstallcertificate', 'signed_value',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500),
                      keep_default=False)

        # Adding unique constraint on 'ZoneKey', fields ['zone']
        db.create_unique('securesync_zonekey', ['zone_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ZoneKey', fields ['zone']
        db.delete_unique('securesync_zonekey', ['zone_id'])

        # Adding field 'ZoneInstallCertificate.install_certificate'
        db.add_column('securesync_zoneinstallcertificate', 'install_certificate',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500),
                      keep_default=False)

        # Deleting field 'ZoneInstallCertificate.signed_value'
        db.delete_column('securesync_zoneinstallcertificate', 'signed_value')
    ...
    models = {
        ...
        'securesync.zonekey': {
            ...
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '32', 'primary_key': 'True'}),
            'private_key': ('django.db.models.fields.TextField', [], {'max_length': '500'}),
