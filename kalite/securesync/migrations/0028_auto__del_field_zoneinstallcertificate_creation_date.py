...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ZoneInstallCertificate.creation_date'
        db.delete_column('securesync_zoneinstallcertificate', 'creation_date')


    def backwards(self, orm):
        # Adding field 'ZoneInstallCertificate.creation_date'
        db.add_column('securesync_zoneinstallcertificate', 'creation_date',
