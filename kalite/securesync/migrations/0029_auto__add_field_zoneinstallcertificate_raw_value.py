...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ZoneInstallCertificate.raw_value'
        db.add_column('securesync_zoneinstallcertificate', 'raw_value',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ZoneInstallCertificate.raw_value'
        db.delete_column('securesync_zoneinstallcertificate', 'raw_value')
