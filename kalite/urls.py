...
if settings.CENTRAL_SERVER:
    ...
    urlpatterns += patterns('central.views',
        ...
        url(r'^organization/(?P<org_id>\w+)/zone/(?P<id>\w+)/edit$', 'zone_form', {}, 'zone_form'),
        url(r'^organization/(?P<org_id>\w+)/zone/(?P<id>\w+)/$', 'zone_management', {}, 'zone_management'),
        url(r'^organization/invite_action/(?P<invite_id>\w+)/$', 'org_invite_action', {}, 'org_invite_action'),
        url(r'^organization/(?P<org_id>\w+)/zone/(?P<zone_id>\w+)/facility/$', 'facility_management', {}, 'facility_manage'),
        url(r'^organization/(?P<org_id>\w+)/zone/(?P<zone_id>\w+)/facility/(?P<id>\w+)/$', 'facility_form', {}, 'facility_form'),
